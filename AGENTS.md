...
- The task orchestrator (Claude or Codex) is the task brain; Codex is the execution engine; this MCP is the reliable session layer.
...
- `turn/start` is the only normal path for task-orchestrator follow-up instructions.
